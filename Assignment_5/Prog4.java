...
// normally if we would like to override these two methods Eat() and Drink then
// we would go for sublcasses and implementing class respectively but here we
// will do it without those thing with anonymous inner class
// syntax//
...
class Prog4 {
    public static void main(String[] args) {
        ...
        obj.Eat();// Normal implemtaiona s in Superclass the original one//
        Drink Supra = new Drink() {
            // Implememting Drink Method inside a anonymous inner class
            public void Drink() {
