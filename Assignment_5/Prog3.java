...
interface NewClass extends Class1, Class2 {
	void m5();
}
class ConcreteClass {
	void concrete() {
...
class ImplementedClass extends ConcreteClass implements NewClass  {
	@Override
	public void m1() {
	...
	@Override
	public void m4() {
		System.out.println("m4() method implemented");
	}

	@Override
	public void m5() {
		System.out.println("m5() method implemented");
	}
}
class Main {
  public static void main(String[] args) {
